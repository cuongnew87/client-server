...
# Write header with csv
with open("clean_data.csv", encoding="utf-8", mode="w", newline='') as file_csv:
	header = ["sdb","tên", "ngày", "tháng", "năm", "toán", "ngữ văn", "khxh", "khtn", "lịch sử", "địa lý", "gdcd", "sinh học", "tiếng anh"]
...
for data in datas:
	...
	data = [sdb_str, name.title(), str(dd), str(mm), str(yy)]

	# add score to data
	for subject in ["toán", "ngữ văn", "khxh", "khtn", "lịch sử", "địa lý", "gdcd", "sinh học", "tiếng anh"]:
